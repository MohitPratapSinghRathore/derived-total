...
\subsection{A horizon that does not depend on behaviour}
\label{sec:hfid}
...
defined on the representation largely avoids this, because it does not depend on
...
scale because it asks a harder question of the model. Action-relevant error at
