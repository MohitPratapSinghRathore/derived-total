"""Build the differential-scaling paper: macros, figure, PDF, anonymous PDF, DOCX.
...
def main():
    ...
    rc = 0
    rc |= run([PY, os.path.join(ROOT, "code", "make_macros_ds.py")])
    rc |= run([PY, os.path.join(ROOT, "code", "figures_ds.py")])
