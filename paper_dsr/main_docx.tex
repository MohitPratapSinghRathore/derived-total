...
12-fold span. This is the direct evidence for the paper's thesis
and it does not depend on any extrapolation. One honest asymmetry is worth recording:
the curvature the category curves imply is +0.0146, smaller than the
+0.0403 actually measured, so the aggregate bends more than the decomposition
