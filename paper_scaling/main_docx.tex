...
18 of 18 models, because hedging lowers it.
\end{abstract}
...
Extending the fitted lines 25-fold beyond our largest model, to
one billion parameters, gives check violations at 0.0413 per position
against empty-source errors at 0.0023, and failures despite
correct local belief at 0.0435. This is far outside the fitted range and
